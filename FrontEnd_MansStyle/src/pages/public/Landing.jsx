      ...
      <footer className="mt-12 bg-[#23272f] text-gray-400 py-8 rounded-t-xl shadow-inner">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 gap-4">
          <div className="text-center md:text-left">
            <span className="font-bold text-[#a78bfa]">Man's Style</span> &copy; {new Date().getFullYear()}
          </div>
          <div className="flex gap-4">
            <a href="#" className="hover:text-[#2563eb] transition">Facebook</a>
            <a href="#" className="hover:text-[#2563eb] transition">Instagram</a>
            <a href="#" className="hover:text-[#2563eb] transition">WhatsApp</a>
          </div>
        </div>
      </footer>
    </>
