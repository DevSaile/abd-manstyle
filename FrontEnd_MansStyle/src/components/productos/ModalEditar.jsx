...
import { actualizarProducto, obtenerMarcas } from "../../services/ProductosService";
...
const ModalEditar = ({
    ...
    useEffect(() => {
        Promise.all([obtenerCategoriasActivas(), obtenerSucursales()]).then(([categoriasData, sucursalesData]) => {
    ...
    useEffect(() => {
        if (openEdit && selectedProducto) {
            ...
            const categoriaValida = categorias.includes(selectedProducto.Descripcion_Categoria)
                ...
                <form className="grid grid-cols-4 gap-4" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setSelectedProducto({ ...selectedProducto, Precio_Producto: e.target.value })
                            }
                            className="w-full bg-gray-700 text-gray-100 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            required
                        />
